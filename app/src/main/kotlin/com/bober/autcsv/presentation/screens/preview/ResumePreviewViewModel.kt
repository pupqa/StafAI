 ...
 * выбранный шаблон, ошибки и флаги готовности.
 */
...
/**
 * ViewModel экрана предпросмотра: загружает резюме, генерирует PDF,
 * обрабатывает события UI и инициирует анализ через репозиторий.
 */
@HiltViewModel
class ResumePreviewViewModel @Inject constructor(
    ...
    /** Колбэк для перехода на экран анализа. */
    ...
    /** Загружает резюме и по готовности запускает генерацию PDF. */
