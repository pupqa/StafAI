            ...
            when (val currentState = state) {
                ...
                is AnalysisState.Success -> {
                    ...
                    LlmLogger.logAnalysisResult(
                        ...
                        "${currentState.analysis.recommendations.size}"
                    )
                    AnalysisContent(
...
@Composable
/** Карточка отображения общего рейтинга (звездами и числом). */
...
@Composable
/** Карточка рекомендации/замечания с иконкой. */
        ...
        Column(
            ...
            IconButton(onClick = onRetry) {
                Icon(
                    ...
                    contentDescription = "Повтор попытки йоу",
                )
            }
        }
    }
...
@Composable
/** Карточка сводной статистики по разделам анализа. */
...
@Composable
/** Элемент статистики: метка и значение, окрашенное в цвет секции. */
